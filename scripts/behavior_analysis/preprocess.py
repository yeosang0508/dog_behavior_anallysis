...
taillow_file_id = '1s-VNQOm8fS7fCaEnOqUDbtZJOeolFbWz' 
...
# 파일 다운로드 
download_file(taillow_file_id, 'data/train/taillow.zip')
download_file(taillow_file_id, 'data/validation/taillow.zip')
...
# 압축 해제
extract_zip('data/train/taillow.zip', 'data/train')
extract_zip('data/validation/taillow.zip', 'data/validation')
